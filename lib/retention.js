...
// Global tuning file written by lib/trainer.js (daily LaunchAgent). Pinned to <clipforge>/data
// so it's found no matter how the server was launched. Missing/corrupt → graceful defaults.
const WEIGHTS_PATH = path.join(__dirname, '..', 'data', 'gaming_heuristics.json');
const H_DEFAULTS = {
